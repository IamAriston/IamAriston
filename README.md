...
I'm a Frontend Engineer from Punjab, India with a focus on building fast, scalable, and maintainable web applications. My work spans citizen-facing government portals, enterprise dashboards, and experimental AR web experiences.

At **The Traffic Solutions Co.** I led frontend development for 6 production applications deployed for Punjab Police and Punjab's civic authorities — platforms used daily by thousands of officers and citizens.

Currently **freelancing** and building a set of ambitious projects while looking for the right full-time role.

- 🔭 Currently building — Plato AR (restaurant AR ordering), a Visual IVR Flow Editor, and an RCS Messaging Platform
- 🏛️ Past impact — Government portals for Punjab Police, traffic management, and civic grievance systems
- 💡 I care about — clean architecture, pixel-perfect UIs, and shipping software that holds up in production
- 🌐 Portfolio — [jasraj.codes](https://jasraj.codes)
- 📍 Based in — Punjab, India · Open to remote & hybrid roles globally
